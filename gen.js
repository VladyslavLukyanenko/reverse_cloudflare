...
var script = fs.readFileSync("src_captcha_v1.js", "utf8");
      ...
      case "SequenceExpression": {
        for (var sidx = 0; sidx < node.expressions.length; sidx++) {
          ...
          if (curr.type === "AssignmentExpression") {
            if (
              curr.left.type !== "MemberExpression" ||
              curr.right.type !== "Literal"
              ) {
                continue;
              }
...
fs.writeFileSync("captcha_v1.deobfuscated.js", escodegen.generate($script), {encoding: "utf8"});
                                                      // console.log(escodegen.generate($script));
